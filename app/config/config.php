...
|
*/
$config['log_threshold'] = (ENVIRONMENT == 'production') ? 0 : 4;
...
|
*/
$config['encryption_key'] = 'jFcjFRgeEdY3FfPuZNqB6dVjd4iNCEmd';
...
$config['sess_cookie_name'] = 'x' . md5($config['encryption_key']);
...
$config['csrf_token_name'] = 'x' . md5($config['sess_cookie_name']);
$config['csrf_cookie_name'] = 'x' . md5($config['csrf_token_name']);
